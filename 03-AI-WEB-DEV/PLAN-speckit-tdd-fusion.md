...
- 본 저장소 내부: `03-AI-WEB-DEV/rules/tdd-policy.md`, `commands/speckit.{specify,plan,tasks}.md`, `subagents/{test-author,bl-analyst,code-reviewer}.md`, `02-PO-DEV-CHAT/skills/spec-generator/spec-pack-schema.md`, `.specify/workflows/speckit/workflow.yml`
