...
**ds-allowlist.md에 정의된 DS 컴포넌트만 screen model과 design page에 사용할 수 있다.**
...
2. 대안이 없으면 **ds-allowlist.md에 신규 컴포넌트를 추가하는 프로세스**를 밟는다.
...
- `layout[].source.ref` 값이 ds-allowlist.md의 컴포넌트 이름 목록에 포함되는지 확인
