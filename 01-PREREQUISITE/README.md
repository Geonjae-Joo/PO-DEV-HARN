...
> PI 작업(②)과 개발(③)이 시작되기 전에 **디자인 자산·규칙·앱 골격을 준비**한다.
...
| `rules/tech-stack.md` | Backend: Spring Boot. Frontend: React + Vite + TypeScript + Tailwind + shadcn/ui. 변경 시 DECISIONS.md 갱신. |
